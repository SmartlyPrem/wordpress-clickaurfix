        ...
        <div class="card border-0 shadow rounded-3 overflow-hidden">
            <div class="card-body p-0">
                <div class="row gx-0">
                    ...
                    <div class="col-lg-6 col-xl-7"><div class="bg-featured-blog" style="background-image: url('<?php the_post_thumbnail_url(get_the_ID(), 'mb-blog-hero'); ?>'); width: 700px; height: 350px; "></div></div>
                </div>
            </div>
        </div>
            ...
            <div class="col-xl-4">
                <div class="card border-0 h-100">
                    <div class="card-body p-4">
                        <div class="h-100 align-items-center justify-content-center" id="sidebar">
