...
vc_map(array(
	...
	'params' => array(
		...
		array(
			...
			'param_name' => 'mb_about_section_2_button_name',
		),
		array(
			'type' => 'textfield',
			'admin_label' => true,
			...
			'param_name' => 'mb_about_section_2_button_link',
		),
		array(
			'type' => 'colorpicker',
			'admin_label' => true,
...
function mb_about_section_2($atts, $content) {
	extract(shortcode_atts(array(	
		...
		'mb_about_section_2_button_name' => '',
		'mb_about_section_2_button_link' => '',
        ...
        <div class="container px-5 my-5">
            <div class="row gx-5 align-items-center">
                ...
                <div class="col-lg-6">
					...
					<div class="mt-4"><a class="btn btn-primary" href="'.$mb_about_section_2_button_link.'">'.$mb_about_section_2_button_name.'</a></div>
                </div>
            </div>
        </div>
    </section>
